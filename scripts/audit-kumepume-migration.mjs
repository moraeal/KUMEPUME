...
const staticRules = {
  ...
  "/blank-8": ["pending-migration", null, "경기도시공사 협력 상세 기록"],
  "/gkl": ["pending-migration", null, "GKL 협력 상세 기록"],
  "/lg": ["pending-migration", null, "LG상사 협력 상세 기록"],
  "/lg-1": ["pending-migration", null, "LG전자 협력 상세 기록"],
  "/blank-11": ["pending-migration", null, "노블하트 클럽 원문"],
  "/blank-10": ["pending-migration", null, "노블하트 선언문 원문"],
  "/blank-9": ["pending-migration", null, "노블레스 자료실 첨부·영상 재검토"],
  "/blank-20": ["pending-migration", null, "노블레스 동영상 원본·권리 재검토"],
  "/578": ["pending-migration", null, "류근철 박사 인물 기록"],
  "/blank-22": ["pending-migration", null, "장기려 박사 인물 기록"],
  "/blank-21": ["pending-migration", null, "도코 도시오 인물 기록"],
  "/blank-6": ["pending-migration", null, "장 크레티앙 인물 기록"],
  "/blank-25": ["pending-migration", null, "강석숭 할아버지 인물 기록"],
  "/blank-26": ["pending-migration", null, "강경환 인물 기록"],
